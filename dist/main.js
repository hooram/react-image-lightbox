        ...
        (function(global) {
            ...
            var ReactImageLightbox = function(_Component) {
                ...
                return _inherits(ReactImageLightbox, _Component), _createClass(ReactImageLightbox, null, [ {
                    ...
                    key: "getTransform",
                    value: function(_ref, sidebarWidth) {
                    ...
                    value: function() {
                        ...
                        var images = [], addImage = function(srcType, imageClass, transforms) {
                            ...
                            if (_this16.props[srcType]) {
                                var bestImageInfo = _this16.getBestImageForType(srcType), imageStyle = _extends({}, transitionStyle, ReactImageLightbox.getTransform(_extends({}, transforms, bestImageInfo), _this16.props.sidebarWidth));
